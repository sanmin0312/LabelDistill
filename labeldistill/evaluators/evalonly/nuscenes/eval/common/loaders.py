    ...
    for sample_token in tqdm.tqdm(sample_tokens, leave=verbose):
        ...
        for sample_annotation_token in sample_annotation_tokens:
            ...
            if box_cls == DetectionBox:
                ...
                # ego distance filter
                #######################################################################################################################################
                ego_dist = [sample_annotation['translation'][0] - ego_pose['translation'][0],
                            sample_annotation['translation'][1] - ego_pose['translation'][1],
                            sample_annotation['translation'][2] - ego_pose['translation'][2]]

                ego_dist = np.linalg.norm(ego_dist, ord=2)

                if ego_dist > 15:
                # if ego_dist <= 15 or ego_dist >= 30:
                # if ego_dist < 30:
                    continue
                #######################################################################################################################################
